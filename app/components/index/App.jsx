    ...
    return (
        <div>
          <footer className="BottomTabNavBar-root-2UQq TabNavBar-root-3qSd">
            ...
            <NavLink onlyActiveOnIndex to="/" className="BottomTabNavBar-tab-di_V TabNavBarItem-tab-1ckL TabNavBarItem-isColumn-37rJ Link-link-3Nen">
            ...
            <NavLink to="/aaa" className="BottomTabNavBar-tab-di_V TabNavBarItem-tab-1ckL TabNavBarItem-isColumn-37rJ Link-link-3Nen">
