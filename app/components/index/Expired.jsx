...
export default class IntergralList extends React.Component {
  ...
  loadList(){
   ...
   componentDidMount() {
         try {
           csb.setLocalTitle('已过期');
       } catch (e) {
         try {
           window.webkit.messageHandlers.setLocalTitle.postMessage('已过期')
         } catch (e) {
                  ...
                  <div  className="history_pay">
                      {
                          that.state.lists.map((e,index)=>{
                              return(
                                 <a  className="product_href block_href" key={index}>
                                    <div className="gift_list">
                                        ...
                                        <div className="gift_desc">
                                            <div className="desc_wrap">
                                                ...
                                                <div className="business_follow2"><span>已过期</span></div>
                                                </div>
                                            </div>
                                        </div>
                                </a>
