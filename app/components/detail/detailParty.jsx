...
export default class detailParty extends React.Component {
    render() {
        return(
          ...
          <a className="LivePageParticipants-link-2pDP" href="/lives/778911679323836416/participants"><div><img alt="mike" className="LivePageParticipants-avatar-3fON Avatar-img--rfs Avatar-rounded-Rnjb" src={require('../../img/detail-avatar1.jpg')} width="24" height="24" />
