...
export default class detailDes extends React.Component {
  ...
  handlerDelete(){
    ...
    $('.omitted').text(where)
    $('.Summary-expandButton-1roc').remove()
  }
    render() {
        return(
          <div>
            ...
            <div className="LivePage-content-2uDl omitted">
            我是王煜全，海银资本创始合伙人， Frost&amp;Sullivan 中国区首席顾问，海外科技产业投资，全球科技前沿分析跟踪者，社会互联网战略咨询专家，《全球风口》作者。
            本次 Live我是马虫，《前列县志：一本书读懂前列腺》作者。哈佛大学医学院联合培养博士生，专业泌尿外科。敬业的外科医生，逗比的理想主义者。知乎医学话题下优秀回答者。我喜欢自己作为泌尿科医生的工作，当我用充满感情的手指抚摸患者前列腺的时候；当恰当的诊疗让患者症状改善的时候；当我收到邀请，开展这场 Live 的时候。 </div><span className="Summary-expandButton-1roc" onClick={this.handlerDelete.bind(this)}>展开全部</span>
            </div>
